...
l42 ==' '==✅  
 ...
 ______   ____  ____   ___ ___   ____  __ __ 
|      T /    T|    \ |   T   T /    T|  T  T
|      |Y  o  ||  D  )| _   _ |Y  o  ||  |  |
l_j  l_j|     ||    / |  \_/  ||     ||  ~  |
  |  |  |  _  ||    \ |   |   ||  _  |l___, |
  |  |  |  |  ||  .  Y|   |   ||  |  ||     !
  l__j  l__j__jl__j\_jl___j___jl__j__jl____/ 
...
def menu():
	...
	_IPYTHONI_(f'\x1b[1;96m[ 1 ] CRACK FILE IDS')
	
	_IPYTHONI_(f'\x1b[1;96m [ 2 ] ID PUBULV [NOT]')
	_____IPYTHONI_____ = input('\x1b[1;96mSELECT :\x1b[1;96m ')
	if _____IPYTHONI_____ in ['1']:
		F()
		print(' \x1b[1;96m\x1b[1;96m\x1b[1;97m LogOut Successful ')
		exit()
	else:
		print(' \x1b[1;96m\x1b[1;96m\x1b[1;91m NOT SELECT ')
		back()
def error():
...
class D:
	...
	def plerr(self):
		...
		try:
			...
			fileX = input ('\x1b[1;98mNAME FILE ️: ')
			for line in open(fileX, 'r').readlines():
				id.append(line.strip())
			print(f'\x1b[1;97mCOLECTED ID : \x1b[1;96m'+str(len(id)))
			Settings()
		except IOError:
...
def passwrd():
	print(f"\x1b[1;97m------------------------------------------------------------")
	print(f"\x1b[1;97m[×] DATE ✔ : \x1b[1;97m{ha}\x1b[1;96m/\x1b[1;97m{bu}\x1b[1;98m/\x1b[1;97m{ta} ")
	print(f"\x1b[1;97m------------------------------------------------------------")
